package com.shenghesun.tank.sso.shiro.conf;
...
import com.shenghesun.tank.sso.redis.realization.CustomRedisCacheManager;
import com.shenghesun.tank.sso.redis.realization.CustomRedisSessionDAO;
import com.shenghesun.tank.sso.shiro.realization.CustomSessionManager;
import com.shenghesun.tank.sso.shiro.realization.CustomShiroRealm;
import com.shenghesun.tank.sso.shiro.realization.CustomSimpleCredentialsMatcher;
...
//		filterChainDefinitionMap.put("/order/rapid_list", "anon");
		...
		filterChainDefinitionMap.put("/v2/order/v2form", "anon");
